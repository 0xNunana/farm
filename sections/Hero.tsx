...
const Hero = () => {
  return (
    <div className='bg-hero bg-cover bg-no-repeat '>
      <div className='bg-gradient-to-r from-black/20 via-black/10 to-black/5 py-20 md:py-28 lg:py-38'>
      <div className='max-w-7xl mx-auto  md:mt-20 md:mb-28 lg:mb-40 px-3 '>
        ...
        <p className='md:py-4 text-yellow text-6xl md:text-7xl font-extrabold '>Agriculture & More</p>
